      ...
      <CardContent>
        <div className="grid w-full max-w-sm items-center gap-2">
          ...
          <Input
            ...
            className="h-16 cursor-pointer file:mr-4 file:py-3 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-primary-foreground hover:file:bg-primary/90"
            disabled={disabled}
          />
        </div>
